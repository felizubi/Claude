<?php if (comments_open() || have_comments()) : ?>
    ...
    <div id="comments" class="uk-margin">
        ...
        <?php if (have_comments()) : ?>
            ...
            <h4 class="uk-h3"><?php printf(__('Comments (%s)', 'warp'), get_comments_number()); ?></h4>
                    ...
                    <li>
                        <article id="comment-<?php comment_ID(); ?>" class="uk-comment <?php echo ($comment->user_id > 0) ? 'uk-comment-primary' : '';?>">
                            ...
                            <header class="uk-comment-header">
                                ...
                                <h5 class="uk-comment-title"><?php echo get_comment_author_link(); ?></h5>
                            ...
                            <div class="uk-comment-body">
                                ...
                                <p class="js-reply"><a href="#" rel="<?php comment_ID(); ?>"><?php echo __('Reply','warp'); ?></a></p>
                                <?php endif; ?>
        ...
        <div id="respond">
            ...
            <h4 class="uk-h3"><?php (comments_open()) ? comment_form_title(__('Leave a comment', 'warp')) : _e('Comments are closed', 'warp'); ?></h4>
