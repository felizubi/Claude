...
final class ITSEC_Lockout {
	...
	private function send_lockout_email( Lockout\Context $context, $host_expiration, $user_expiration, $reason ) {
		...
		$mail->add_header( esc_html__( 'Site Lockout Notification', 'it-l10n-ithemes-security-pro' ), esc_html__( 'Site Lockout Notification', 'it-l10n-ithemes-security-pro' ), false, $tracking_link );
