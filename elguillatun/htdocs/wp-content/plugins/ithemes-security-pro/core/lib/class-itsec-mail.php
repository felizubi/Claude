...
final class ITSEC_Mail {
	...
	public function add_header( $title, $banner_title, $use_site_logo = false, $tracking_link = '' ) {
		...
		$replacements = array(
			...
			'branding_title'    => esc_html__( 'iThemes Security is becoming Solid Security', 'it-l10n-ithemes-security-pro' ),
			'text'              => esc_html__( 'We have been working hard for almost a year to bring you incredible new features in the form of our new and improved brand: SolidWP. Discover what’s coming very soon!', 'it-l10n-ithemes-security-pro' ),
