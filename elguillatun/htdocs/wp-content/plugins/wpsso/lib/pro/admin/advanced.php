...
if ( ! class_exists( 'WpssoProAdminAdvanced' ) ) {
	...
	class WpssoProAdminAdvanced {
		...
		private $schema_type_event_args = array();
		...
		public function __construct( &$plugin ) {
			...
			if ( ! empty( $this->p->options[ 'plugin_wpsso_tid' ] ) &&
				...
				$this->p->util->add_plugin_filters( $this, array(
					...
					'mb_advanced_schema_defs_job_posting_rows'    => 3,	// Schema Defaults > Job tab.
				...
				$this->schema_type_event_args = array(
			...
			} else WpssoLoader::load_plugin_std( $plugin, 'admin', 'advanced' );
		}
		...
		public function filter_mb_advanced_plugin_integration_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'plugin_title_tag' ] = '' .
				...
				'<td>' . $form->get_select( 'plugin_title_tag', $doc_title_source,
					$css_class = 'long_name', $css_id = '', $is_assoc = true, $doc_title_disabled ) .
				$doc_title_msg . '</td>' .
			...
			$table_rows[ 'plugin_filter_content' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_filter_content' ) . ' ' .
				_x( '(recommended - see help text)', 'option comment', 'wpsso' ) . '</td>' .
			...
			$table_rows[ 'plugin_filter_excerpt' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_filter_excerpt' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_filter_excerpt' ) . ' ' .
				_x( '(recommended - only if using shortcodes in excerpts)', 'option comment', 'wpsso' ) . '</td>' .
			...
			$table_rows[ 'plugin_page_excerpt' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_page_excerpt' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_page_excerpt' ) . '</td>' .
			...
			$table_rows[ 'plugin_page_tags' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_page_tags' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_page_tags' ) . '</td>' .
			...
			$table_rows[ 'plugin_new_user_is_person' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_new_user_is_person' ) . '</td>' .
			...
			$table_rows[ 'plugin_inherit_featured' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_inherit_featured' ) . ' ' .
			...
			$table_rows[ 'plugin_inherit_images' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_inherit_images' ) . ' ' .
				_x( '(recommended)', 'option comment', 'wpsso' ) . '</td>' .
				WpssoAdmin::get_option_site_use( 'plugin_inherit_images', $form, $args[ 'network' ] );
			...
			$table_rows[ 'plugin_check_img_dims' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_check_img_dims' ) . ' ' .
				_x( '(recommended)', 'option comment', 'wpsso' ) . '</td>' .
			...
			$table_rows[ 'plugin_prevent_thumb_conflicts' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_prevent_thumb_conflicts' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_prevent_thumb_conflicts' ) . ' ' .
				_x( '(recommended)', 'option comment', 'wpsso' ) . '</td>' .
			...
			$table_rows[ 'plugin_upscale_images' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_upscale_images' ) . '</td>' .
			...
			$table_rows[ 'plugin_upscale_pct_max' ] = '' .
				...
				'<td>' . $form->get_input( 'plugin_upscale_pct_max', $css_class = 'short' ) . ' %</td>' .
			...
			$table_rows[ 'plugin_speakable_css_csv' ] = '' .
				...
				'<td>' . $form->get_input( 'plugin_speakable_css_csv', $css_class = 'wide' ) .
			...
			$table_rows[ 'plugin_check_head' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_check_head' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_check_head' ) . '</td>' .
			...
			$table_rows[ 'plugin_product_include_vat' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_product_include_vat' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_aioseop_meta' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_aioseop_meta' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_rankmath_meta' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_rankmath_meta' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_seoframework_meta' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_seoframework_meta' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_wpmetaseo_meta' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_wpmetaseo_meta' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_wpseo_meta' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_wpseo_meta' ) . '</td>' .
			...
			$table_rows[ 'plugin_import_wpseo_blocks' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_import_wpseo_blocks' ) . '</td>' .
		...
		public function filter_mb_advanced_plugin_default_text_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'plugin_title_part_site' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_title_part_site', $css_class = 'long_name',
					$css_id = '', $len = 0, $holder = '', $doc_title_disabled ) . $doc_title_msg . '</td>';
			...
			$table_rows[ 'plugin_title_part_tagline' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_title_part_tagline', $css_class = 'wide',
					$css_id = '', $len = 0, $holder = '', $doc_title_disabled ) . $doc_title_msg . '</td>';
			...
			$table_rows[ 'plugin_img_alt_prefix' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_img_alt_prefix' ) . '</td>';
			...
			$table_rows[ 'plugin_p_cap_prefix' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_p_cap_prefix' ) . '</td>';
			...
			$table_rows[ 'plugin_comment_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_comment_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_comment_reply_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_comment_reply_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_comment_review_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_comment_review_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_product_var_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_product_var_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_feed_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_feed_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_404_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_404_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_404_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_404_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_no_title_text' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_no_title_text', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_no_desc_text' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_no_desc_text', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_term_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_term_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_term_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_term_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_author_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_author_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_author_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_author_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_search_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_search_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_search_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_search_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_year_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_year_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_year_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_year_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_month_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_month_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_month_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_month_page_desc', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_day_page_title' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_day_page_title', $css_class = 'wide' ) . '</td>';
			...
			$table_rows[ 'plugin_day_page_desc' ] = '' .
				...
				'<td>' . $form->get_input_locale( 'plugin_day_page_desc', $css_class = 'wide' ) . '</td>';
		...
		public function filter_mb_advanced_plugin_image_sizes_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'og_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'og_img' ) . '</td>';
			...
			$table_rows[ 'pin_img_size' ] = ( $pin_img_disabled ? $form->get_tr_hide( $in_view = 'basic' ) : '' ) .
				...
				'<td>' . $form->get_input_image_dimensions( 'pin_img', $pin_img_disabled ) . $pin_img_msg . '</td>';
			...
			$table_rows[ 'schema_01_01_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'schema_1x1_img' ) . '</td>';
			...
			$table_rows[ 'schema_04_03_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'schema_4x3_img' ) . '</td>';
			...
			$table_rows[ 'schema_16_09_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'schema_16x9_img' ) . '</td>';
			...
			$table_rows[ 'tc_00_sum_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'tc_sum_img' ) . '</td>';
			...
			$table_rows[ 'tc_01_lrg_img_size' ] = '' .
				...
				'<td>' . $form->get_input_image_dimensions( 'tc_lrg_img' ) . '</td>';
		...
		public function filter_mb_advanced_plugin_interface_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'plugin_og_types_select_format' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_og_types_select_format' ) .
				...
				'<td>' . $form->get_select( 'plugin_og_types_select_format',
			...
			$table_rows[ 'plugin_schema_types_select_format' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_schema_types_select_format' ) .
				...
				'<td>' . $form->get_select( 'plugin_schema_types_select_format',
					$this->p->cf[ 'form' ][ 'og_schema_types_select_format' ] ) . '</td>';
			...
			$table_rows[ 'plugin_add_toolbar_validate' ] = '' .
				...
				'<td>' . $form->get_checkbox( 'plugin_add_toolbar_validate' ) . '</td>';
			...
			$table_rows[ 'plugin_add_submenu' ] = $form->get_tr_hide_prefix( $in_view = 'basic', 'plugin_add_submenu_' ) .
				...
				'<td>' . $form->get_checklist( $name_prefix = 'plugin_add_submenu', $values ) . '</td>';
			...
			$table_rows[ 'plugin_add_to' ] = $form->get_tr_hide_prefix( $in_view = 'basic', 'plugin_add_to_' ) .
				...
				'<td>' . $form->get_checklist_post_tax_user( $name_prefix = 'plugin_add_to' ) . '</td>';
			...
			$table_rows[ 'plugin_show_columns' ] = '' .
				...
				'<td>' . $form->get_columns_post_tax_user( $name_prefix = 'plugin',
		...
		public function filter_mb_advanced_services_media_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'plugin_gravatar_image' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_gravatar_image' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_gravatar_image' ) . '</td>';
			...
			$table_rows[ 'plugin_gravatar_size' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_gravatar_size' ) .
				...
				'<td>' . $form->get_input( 'plugin_gravatar_size', $css_class = 'short' ) . '</td>';

			$checkboxes = '';

			foreach ( $this->p->cf[ 'form' ][ 'embed_media' ] as $opt_key => $opt_label ) {

				$checkboxes .= '<p>' . $form->get_checkbox( $opt_key ) . ' ' . _x( $opt_label, 'option value', 'wpsso' ) . '</p>';
			}
		...
		public function filter_mb_advanced_services_shortening_rows( $table_rows, $form, $args ) {
			...
			$shorteners = $this->p->cf[ 'form' ][ 'shorteners' ];
			...
			$table_rows[ 'plugin_shortener' ] = '' .
				...
				'<td>' . $form->get_select( 'plugin_shortener', $shorteners, $css_class = '', $css_id = 'plugin_shortener',
			...
			$table_rows[ 'plugin_min_shorten' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_min_shorten' ) .
				...
				'<td>' . $form->get_input( 'plugin_min_shorten', $css_class = 'short' ) . ' ' .
			...
			$table_rows[ 'plugin_wp_shortlink' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_wp_shortlink' ) .
				...
				'<td>' . $form->get_checkbox( 'plugin_wp_shortlink' ) . '</td>';
			...
			$table_rows[ 'plugin_add_link_rel_shortlink' ] = $form->get_tr_hide( $in_view = 'basic', 'add_link_rel_shortlink' ) .
				...
				'<td>' . $form->get_checkbox( 'add_link_rel_shortlink', $css_class = '', $css_id = 'add_link_rel_shortlink_html_tag',
					$is_disabled = false, $force = null, $group = 'add_link_rel_shortlink' ) . '</td>';	// Group with option in head tags list.

			/*
			 * Bitly URL shortener.
			 */
			$table_rows[ 'subsection_plugin_bitly' ] = $form->get_tr_on_change( 'plugin_shortener', 'bitly' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'Bitly (URL Shortener)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_bitly_access_token' ] = $form->get_tr_on_change( 'plugin_shortener', 'bitly' ) .
				$form->get_th_html( _x( 'Bitly Generic Access Token', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_bitly_access_token' ) .
				'<td>' . $form->get_input( 'plugin_bitly_access_token', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_bitly_domain' ] = $form->get_tr_on_change( 'plugin_shortener', 'bitly' ) .
				$form->get_th_html( _x( 'Bitly Short Domain (Optional)', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_bitly_domain' ) .
				'<td>' . $form->get_input( 'plugin_bitly_domain', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_bitly_group_name' ] = $form->get_tr_on_change( 'plugin_shortener', 'bitly' ) .
				$form->get_th_html( _x( 'Bitly Group Name (Optional)', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_bitly_group_name' ) .
				'<td>' . $form->get_input( 'plugin_bitly_group_name', $css_class = 'api_key' ) . '</td>';

			/*
			 * DLMY.App URL shortener.
			 */
			$table_rows[ 'subsection_plugin_dlmyapp' ] = $form->get_tr_on_change( 'plugin_shortener', 'dlmyapp' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'DLMY.App (URL Shortener)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_dlmyapp_api_key' ] = $form->get_tr_on_change( 'plugin_shortener', 'dlmyapp' ) .
				$form->get_th_html( _x( 'DLMY.App API Key', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_dlmyapp_api_key' ) .
				'<td>' . $form->get_input( 'plugin_dlmyapp_api_key', $css_class = 'api_key' ) . '</td>';

			/*
			 * Owly URL shortener.
			 */
			$table_rows[ 'subsection_plugin_owly' ] = $form->get_tr_on_change( 'plugin_shortener', 'owly' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'Ow.ly (URL Shortener)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_owly_api_key' ] = $form->get_tr_on_change( 'plugin_shortener', 'owly' ) .
				$form->get_th_html( _x( 'Ow.ly API Key', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_owly_api_key' ) .
				'<td>' . $form->get_input( 'plugin_owly_api_key', $css_class = 'api_key' ) . '</td>';

			/*
			 * YOURLS URL shortener.
			 */
			$table_rows[ 'subsection_plugin_yourls' ] = $form->get_tr_on_change( 'plugin_shortener', 'yourls' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'YOURLS (URL Shortener)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_yourls_api_url' ] = $form->get_tr_on_change( 'plugin_shortener', 'yourls' ) .
				$form->get_th_html( _x( 'YOURLS API URL', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_yourls_api_url' ) .
				'<td>' . $form->get_input( 'plugin_yourls_api_url', $css_class = 'api_key wide' ) . '</td>';

			$table_rows[ 'plugin_yourls_username' ] = $form->get_tr_on_change( 'plugin_shortener', 'yourls' ) .
				$form->get_th_html( _x( 'YOURLS Username', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_yourls_username' ) .
				'<td>' . $form->get_input( 'plugin_yourls_username', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_yourls_password' ] = $form->get_tr_on_change( 'plugin_shortener', 'yourls' ) .
				$form->get_th_html( _x( 'YOURLS Password', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_yourls_password' ) .
				'<td>' . $form->get_input( 'plugin_yourls_password', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_yourls_token' ] = $form->get_tr_on_change( 'plugin_shortener', 'yourls' ) .
				$form->get_th_html( _x( 'YOURLS Token', 'option label', 'wpsso' ), $css_class = '', $css_id = 'plugin_yourls_token' ) .
				'<td>' . $form->get_input( 'plugin_yourls_token', $css_class = 'api_key' ) . '</td>';
		...
		public function filter_mb_advanced_services_ratings_reviews_rows( $table_rows, $form, $args ) {
			...
			$table_rows[ 'plugin_ratings_reviews_svc' ] = '' .
				...
				'<td>' . $form->get_select( 'plugin_ratings_reviews_svc', $ratings_reviews, $css_class = '', $css_id = 'plugin_ratings_reviews_svc',
					$is_assoc = true, $is_disabled = false, $selected = false, $event_names = array( 'on_change_unhide_rows' ) ) . '</td>';
			...
			$table_rows[ 'plugin_ratings_reviews_num_max' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_ratings_reviews_num_max' ) .
				...
				'<td>' . $form->get_input( 'plugin_ratings_reviews_num_max', $css_class = 'short' ) . '</td>';
			...
			$table_rows[ 'plugin_ratings_reviews_months_max' ] = $form->get_tr_hide( $in_view = 'basic', 'plugin_ratings_reviews_months_max' ) .
				...
				'<td>' . $form->get_input( 'plugin_ratings_reviews_months_max', $css_class = 'short' ) . ' ' .
			...
			$table_rows[ 'plugin_ratings_reviews_for' ] = '' .
				...
				'<td>' . $form->get_checklist_post_types( $name_prefix = 'plugin_ratings_reviews_for' ) . '</td>';

			/*
			 * Judge.me.
			 */
			$table_rows[ 'subsection_plugin_judgeme' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'judgeme' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'Judge.me (Ratings and Reviews)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_judgeme_shop_domain' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'judgeme' ) .
				$form->get_th_html( _x( 'Judge.me Shop Domain', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_judgeme_shop_domain' ) .
				'<td>' . $form->get_input( 'plugin_judgeme_shop_domain', $css_class = 'wide' ) . '</td>';

			$table_rows[ 'plugin_judgeme_shop_token' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'judgeme' ) .
				$form->get_th_html( _x( 'Judge.me Shop Token', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_judgeme_shop_token' ) .
				'<td>' . $form->get_input( 'plugin_judgeme_shop_token', $css_class = 'api_key' ) . '</td>';

			/*
			 * Shopper Approved.
			 */
			$table_rows[ 'subsection_plugin_shopperapproved' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'shopperapproved' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'Shopper Approved (Ratings and Reviews)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_shopperapproved_site_id' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'shopperapproved' ) .
				$form->get_th_html( _x( 'Shopper Approved Site ID', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_shopperapproved_site_id' ) .
				'<td>' . $form->get_input( 'plugin_shopperapproved_site_id', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_shopperapproved_token' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'shopperapproved' ) .
				$form->get_th_html( _x( 'Shopper Approved API Token', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_shopperapproved_token' ) .
				'<td>' . $form->get_input( 'plugin_shopperapproved_token', $css_class = 'api_key' ) . '</td>';

			/*
			 * Stamped.io.
			 */
			$table_rows[ 'subsection_plugin_stamped' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'stamped' ) .
				'<td colspan="2" class="subsection"><h4>' . _x( 'Stamped.io (Ratings and Reviews)', 'metabox title', 'wpsso' ) . '</h4></td>';

			$table_rows[ 'plugin_stamped_store_hash' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'stamped' ) .
				$form->get_th_html( _x( 'Stamped.io Store Hash', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_stamped_store_hash' ) .
				'<td>' . $form->get_input( 'plugin_stamped_store_hash', $css_class = 'api_key' ) . '</td>';

			$table_rows[ 'plugin_stamped_key_public' ] = $form->get_tr_on_change( 'plugin_ratings_reviews_svc', 'stamped' ) .
				$form->get_th_html( _x( 'Stamped.io API Key Public', 'option label', 'wpsso' ),
					$css_class = '', $css_id = 'plugin_stamped_key_public' ) .
				'<td>' . $form->get_input( 'plugin_stamped_key_public', $css_class = 'api_key' ) . '</td>';
		...
		public function filter_mb_advanced_doc_types_og_types_rows( $table_rows, $form, $args ) {
			...
			foreach ( array(
				...
				$table_rows[ $opt_key ] = $form->get_tr_hide( $in_view = 'basic', $opt_key ) .
					...
					'<td>' . $form->get_select( $opt_key, $args[ 'select_names' ][ 'og_types' ],
			...
			foreach ( $type_labels as $opt_key => $obj_label ) {
				...
				$type_select .= '<p>' . $form->get_select( $opt_key, $args[ 'select_names' ][ 'og_types' ],
		...
		public function filter_mb_advanced_doc_types_schema_types_rows( $table_rows, $form, $args ) {
			...
			foreach ( array(
				...
				$table_rows[ $opt_key ] = $form->get_tr_hide( $in_view = 'basic', $opt_key ) .
					$form->get_th_html( $th_label, $css_class = '', $opt_key ) .
					'<td>' . $form->get_select( $opt_key, $args[ 'select_names' ][ 'schema_types' ],
						$css_class = 'schema_type', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
							$event_names = array( 'on_focus_load_json' ), $this->schema_type_event_args ) . '</td>';
			}
			...
			foreach ( $type_labels as $opt_key => $obj_label ) {
				...
				$type_select .= '<p>' . $form->get_select( $opt_key, $args[ 'select_names' ][ 'schema_types' ],
					$css_class = 'schema_type', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
						$event_names = array( 'on_focus_load_json' ), $this->schema_type_event_args ) . ' ' .
		...
		public function filter_mb_advanced_schema_defs_article_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_add_articlebody_prop' => array(
					...
					'content'  => $form->get_checkbox( 'schema_def_add_articlebody_prop' ),
				),
				'schema_def_article_section' => array(
					'label'    => _x( 'Default Article Section', 'option label', 'wpsso' ),
					'tooltip'  => 'schema_def_article_section',
					'content'  => $form->get_select( 'schema_def_article_section', $args[ 'select_names' ][ 'article_sections' ],
						$css_class = '', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
		...
		public function filter_mb_advanced_schema_defs_book_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_book_format' => array(
					...
					'content'  => $form->get_select( 'schema_def_book_format', $this->p->cf[ 'form' ][ 'book_format' ],
		...
		public function filter_mb_advanced_schema_defs_creative_work_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_add_text_prop' => array(
					...
					'content'  => $form->get_checkbox( 'schema_def_add_text_prop' ),
				),
				'schema_def_family_friendly' => array(
					'label'    => _x( 'Default Family Friendly', 'option label', 'wpsso' ),
					'tooltip'  => 'schema_def_family_friendly',
					'content'  => $form->get_select_none( 'schema_def_family_friendly', $this->p->cf[ 'form' ][ 'yes_no' ],
						$css_class = 'yes-no', $css_id = '', $is_assoc = true ),
				),
				'schema_def_pub_org_id' => array(
					'label'    => _x( 'Default Publisher Org.', 'option label', 'wpsso' ),
					'tooltip'  => 'schema_def_pub_org_id',
					'content'  => $form->get_select( 'schema_def_pub_org_id', $args[ 'select_names' ][ 'org' ],
				...
				'schema_def_pub_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_pub_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
				...
				'schema_def_prov_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_prov_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_prov_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_prov_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'person_names' ) ),
				),
				'schema_def_fund_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_fund_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_fund_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_fund_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'person_names' ) ),
				),
		...
		public function filter_mb_advanced_schema_defs_event_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_event_attendance' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_attendance', $this->p->cf[ 'form' ][ 'event_attendance' ],
						$css_class = '', $css_id = '', $is_assoc = true ),
				),
				'schema_def_event_location_id' => array(
					'label'    => _x( 'Default Event Venue', 'option label', 'wpsso' ),
					'tooltip'  => 'schema_def_event_location_id',
					'content'  => $form->get_select( 'schema_def_event_location_id', $args[ 'select_names' ][ 'place' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
				...
				'schema_def_event_performer_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_performer_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_event_performer_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_performer_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'person_names' ) ),
				),
				'schema_def_event_organizer_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_organizer_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_event_organizer_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_organizer_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'person_names' ) ),
				),
				'schema_def_event_fund_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_fund_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_event_fund_person_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_event_fund_person_id', $args[ 'select_names' ][ 'person' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'person_names' ) ),
				),
		...
		public function filter_mb_advanced_schema_defs_job_posting_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_job_hiring_org_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_job_hiring_org_id', $args[ 'select_names' ][ 'org' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'org_names' ) ),
				),
				'schema_def_job_location_id' => array(
					...
					'content'  => $form->get_select( 'schema_def_job_location_id', $args[ 'select_names' ][ 'place' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false,
							$selected = false, $event_names = array( 'on_focus_load_json' ),
								$event_args = array( 'json_var' => 'place_names' ) ),
				),
				'schema_def_job_location_type' => array(
					...
					'content'  => $form->get_select( 'schema_def_job_location_type', $this->p->cf[ 'form' ][ 'job_location_type' ],
		...
		public function filter_mb_advanced_schema_defs_place_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_place_schema_type' => array(
					...
					'content'  => $form->get_select( 'schema_def_place_schema_type', $args[ 'select_names' ][ 'place_types' ],
						$css_class = 'schema_type', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
							$event_names = array( 'on_focus_load_json' ), $event_args = array(
								'json_var'  => 'place_types',
								'exp_secs'  => WPSSO_CACHE_SELECT_JSON_EXP_SECS,	// Create and read from a javascript URL.
								'is_transl' => true,					// No label translation required.
								'is_sorted' => true,					// No label sorting required.
							)
				...
				'schema_def_place_country' => array(
					...
					'content' => $form->get_select_country( 'schema_def_place_country' ),
				),
				'schema_def_place_timezone' => array(
					'label'   => _x( 'Default Place Timezone', 'option label', 'wpsso' ),
					'tooltip' => 'schema_def_place_country',
					'content' => $form->get_select_timezone( 'schema_def_place_timezone' ),
				),
			);
		...
		public function filter_mb_advanced_schema_defs_product_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_product_aggr_offers' => array(
					...
					'content'  => $form->get_checkbox( 'schema_def_product_aggr_offers' ) . ' ' .
				...
				'schema_def_product_mrp' => array(
					...
					'content'  => $form->get_select( 'schema_def_product_mrp', $args[ 'select_names' ][ 'mrp' ],
				...
				'schema_def_product_category' => array(	// Product Google Category ID.
					...
					'content' => $form->get_select( 'schema_def_product_category', $args[ 'select_names' ][ 'google_prod_cats' ],
						$css_class = 'wide', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
							$event_names = array( 'on_focus_load_json' ), $event_args = array(
								'json_var'  => 'google_prod_cats',
								'exp_secs'  => WPSSO_CACHE_SELECT_JSON_EXP_SECS,	// Create and read from a javascript URL.
								'is_transl' => true,					// No label translation required.
								'is_sorted' => true,					// No label sorting required.
							)
				...
				'schema_def_product_price_type' => array(
					...
					'content' => $form->get_select( 'schema_def_product_price_type', $this->p->cf[ 'form' ][ 'price_type' ] ),
				),
				'schema_def_product_condition' => array(
					...
					'content' => $form->get_select( 'schema_def_product_condition', $this->p->cf[ 'form' ][ 'item_condition' ] ),
				),
				'schema_def_product_energy_efficiency_min_max' => array(
					...
					'content' => '' .
						$form->get_select( 'schema_def_product_energy_efficiency_min', $this->p->cf[ 'form' ][ 'energy_efficiency' ],
							$css_class = 'energy_efficiency', $css_id = '', $is_assoc = 'sorted' ) . ' ' .
						_x( 'to', 'option comment', 'wpsso' ) . ' ' .
						$form->get_select( 'schema_def_product_energy_efficiency_max', $this->p->cf[ 'form' ][ 'energy_efficiency' ],
							$css_class = 'energy_efficiency', $css_id = '', $is_assoc = 'sorted' ),
				),
				'schema_def_product_target_gender' => array(
					...
					'content'  => $form->get_select( 'schema_def_product_target_gender', $this->p->cf[ 'form' ][ 'target_gender' ],
				...
				'schema_def_product_size_group' => array(
					...
					'content'  => '' .
						$form->get_select( 'schema_def_product_size_group_0', $this->p->cf[ 'form' ][ 'size_group' ],
							$css_class = 'size_group', $css_id = '', $is_assoc = true ) . ' ' .
						$form->get_select( 'schema_def_product_size_group_1', $this->p->cf[ 'form' ][ 'size_group' ],
							$css_class = 'size_group', $css_id = '', $is_assoc = true ),
				),
				'schema_def_product_size_system' => array(
					...
					'content' => $form->get_select( 'schema_def_product_size_system', $this->p->cf[ 'form' ][ 'size_system' ] ),
				),
				'schema_def_product_age_group' => array(
					...
					'content' => $form->get_select( 'schema_def_product_age_group', $this->p->cf[ 'form' ][ 'age_group' ] ),
				),
				'schema_def_product_adult_type' => array(
					...
					'content' => $form->get_select( 'schema_def_product_adult_type', $this->p->cf[ 'form' ][ 'adult_type' ] ),
				),
			);
		...
		public function filter_mb_advanced_schema_defs_profile_page_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_profile_page_mentions_prop' => array(
					...
					'content'  => $form->get_checkbox( 'schema_def_profile_page_mentions_prop' ),
				),
			);
		...
		public function filter_mb_advanced_schema_defs_review_rows( $table_rows, $form, $args ) {
			...
			$form_rows = array(
				'schema_def_review_rating_min' => array(
					...
					'content'  => $form->get_input( 'schema_def_review_rating_min', $css_class = 'rating' ),
				),
				'schema_def_review_rating_max' => array(
					...
					'content'  => $form->get_input( 'schema_def_review_rating_max', $css_class = 'rating' ),
				),
				'schema_def_review_item_type' => array(
					...
					'content'  => $form->get_select( 'schema_def_review_item_type', $args[ 'select_names' ][ 'schema_types' ],
						$css_class = 'schema_type', $css_id = '', $is_assoc = true, $is_disabled = false, $selected = false,
							$event_names = array( 'on_focus_load_json' ), $this->schema_type_event_args ),
				),
			);
		...
		public function filter_mb_advanced_contact_fields_default_cm_rows( $table_rows, $form, $args ) {
			...
			$table_rows[] = '<th class="medium"></th>' .
				$form->get_th_html( _x( 'Show', 'column title', 'wpsso' ), $css_class = 'checkbox left', $css_id = 'custom-cm-show-checkbox' ) .
				$form->get_th_html( _x( 'Contact Field ID', 'column title', 'wpsso' ), $css_class = 'medium left', $css_id = 'wp-cm-field-id' ) .
				$form->get_th_html_locale( _x( 'Contact Field Label', 'column title', 'wpsso' ), $css_class = 'wide left', $css_id = 'custom-cm-field-label' );
			...
			foreach ( $sorted_cm_names as $cm_id => $opt_label ) {
				...
				$table_rows[] = '' .
					...
					'<td class="checkbox">' . $form->get_checkbox( $cm_enabled_key ) . '</td>' .
					'<td class="medium">' . $form->get_no_input( $cm_name_key, $css_class = 'medium' ) . '</td>' .
					'<td class="wide">' . $form->get_input_locale( $cm_label_key ) . '</td>';
			}
		...
		public function filter_mb_advanced_contact_fields_custom_cm_rows( $table_rows, $form, $args ) {
			...
			$table_rows[] = '<th class="medium"></th>' .
				$form->get_th_html( _x( 'Show', 'column title', 'wpsso' ), $css_class = 'checkbox left', $css_id = 'custom-cm-show-checkbox' ) .
				$form->get_th_html( _x( 'Contact Field ID', 'column title', 'wpsso' ), $css_class = 'medium left', $css_id = 'custom-cm-field-id' ) .
				$form->get_th_html_locale( _x( 'Contact Field Label', 'column title', 'wpsso' ), $css_class = 'wide left', $css_id = 'custom-cm-field-label' );
			...
			foreach ( $this->p->cf[ 'opt' ][ 'cm_prefix' ] as $cm_id => $opt_pre ) {
				...
				if ( isset( $form->options[ $cm_enabled_key ] ) ) {
					...
					$table_rows[] = '' .
						...
						'<td class="checkbox">' . $form->get_checkbox( $cm_enabled_key ) . '</td>' .
						'<td class="medium">' . $form->get_input( $cm_name_key, $css_class = 'medium' ) . '</td>' .
						'<td class="wide">' . $form->get_input_locale( $cm_label_key ) . '</td>';
				}
			}
		...
		public function filter_mb_advanced_user_about_rows( $table_rows, $form, $args ) {
			...
			foreach ( $this->p->cf[ 'opt' ][ 'user_about' ] as $key => $opt_label ) {
				...
				$table_rows[ $opt_key ] = '' .
					...
					'<td class="checkbox">' . $form->get_checkbox( $opt_key ) . '</td>';
			}
		...
		public function filter_mb_advanced_metadata_product_attrs_rows( $table_rows, $form, $args ) {
			...
			foreach ( $opts_transl as $opt_key => $opt_label_transl ) {
				...
				$table_rows[ $opt_key ] = '' .
					...
					'<td>' . $form->get_input_locale( $opt_key ) . $cmt_transl . '</td>';
			}
		...
		public function filter_mb_advanced_metadata_custom_fields_rows( $table_rows, $form, $args ) {
			...
			foreach ( $opts_transl as $opt_cf_key => $opt_label_transl ) {
				...
				$table_rows[ $opt_cf_key ] = '' .
					...
					'<td>' . $form->get_input( $opt_cf_key, $css_class = '', $css_id = '',
		...
		private function get_head_tags_rows( $table_rows, $form, array $opt_preg_include ) {
			...
			foreach ( $opt_preg_include as $preg ) {
				...
				foreach ( $form->defaults as $opt_key => $opt_val ) {
					...
					if ( 0 !== strpos( $opt_key, 'add_' ) ) {	// Optimize.
					...
					$table_cells[] = '<!-- ' . ( implode( ' ', $match ) ) . ' -->' . 	// Required for sorting.
						'<td class="checkbox">' . $form->get_checkbox( $opt_key, $css_class, $css_id, $disabled, $force, $group ) . '</td>' .
