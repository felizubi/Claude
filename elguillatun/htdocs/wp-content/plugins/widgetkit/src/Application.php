...
class Application extends BaseApplication implements EventSubscriberInterface
{
    ...
    public function initAdmin()
    {
        ...
        $this['scripts']->add('widgetkit-admin', 'assets/js/admin.js', array('uikit2', 'uikit2-notify', 'uikit2-nestable', 'uikit2-sortable', 'application-translator', 'angular', 'angular-resource', 'angular-touch'));
