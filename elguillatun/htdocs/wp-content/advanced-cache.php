...
$rocket_path        = '/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/wp-rocket/';
$rocket_config_path = '/opt/bitnami/apps/wordpress/htdocs/wp-content/wp-rocket-config/';
$rocket_cache_path  = '/opt/bitnami/apps/wordpress/htdocs/wp-content/cache/wp-rocket/';
...
if ( file_exists( '/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php' ) && ! class_exists( 'WP_Rocket_Mobile_Detect' ) ) {
	include_once '/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php';
}
